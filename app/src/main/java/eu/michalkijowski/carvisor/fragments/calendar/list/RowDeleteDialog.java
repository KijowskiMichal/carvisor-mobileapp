...
public class RowDeleteDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(getActivity())
                ...
                .setTitle("Czy chcesz usunąć zdarzenie "+name+"?")
    ...
    private class DeleteDevice extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            CalendarService.deleteEvent(Integer.valueOf(tag));
            return null;
        }
        ...
        protected void onPostExecute(Void params) {
            ...
            Toast.makeText(context, "Poprawnie usunięto zdarzenie.", Toast.LENGTH_LONG).show();
